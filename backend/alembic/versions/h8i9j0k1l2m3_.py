...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "holiday_type",
            sa.dialects.postgresql.ENUM("gw", "sw", "year_end", name="longholidaytypeenum", create_type=False),
            nullable=False,
        ),
    ...
    op.add_column(
        ...
        sa.Column(
            "transfer_type",
            sa.dialects.postgresql.ENUM("no_transfer", "transfer_in", "transfer_out", name="transfertypeenum", create_type=False),
            nullable=True,
        ),
    )
    op.add_column(
