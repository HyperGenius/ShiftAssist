...
export const SMART_SUGGEST_GRID_COLS = "grid-cols-[18px_20px_80px_40px_40px_76px]";
...
export function SmartSuggestRow({
  ...
  return (
    ...
    >
      ...
      {/* 列6: 集計情報 */}
      <span className="text-center text-gray-400 text-[10px] whitespace-nowrap">
        {statsText}
      </span>
    </div>
  );
