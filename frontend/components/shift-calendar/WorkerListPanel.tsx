...
export function WorkerListPanel({
  ...
  return (
    <div className="flex flex-col h-full bg-slate-900/80 border border-slate-700/60 rounded-lg backdrop-blur-sm">
      {/* パネルヘッダー */}
      <div className="px-3 py-2 border-b border-slate-700/60">
        <div className="flex items-center justify-between mb-1">
          <h3 className="text-xs font-semibold tracking-wider text-cyan-300 uppercase">
            対応者リスト
          </h3>
