    ...
    <div className="flex flex-col gap-1">
      ...
      {workerSelections.map((workerId, idx) => (
        <select
          ...
          className="bg-slate-800/60 border border-slate-600/50 rounded px-1.5 py-1 text-xs text-slate-200 focus:outline-none focus:ring-1 focus:ring-cyan-500/70 focus:border-cyan-500/70 transition-colors w-full"
